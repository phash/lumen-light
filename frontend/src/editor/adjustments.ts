...
export const ADJUSTMENTS: ReadonlyArray<AdjustmentDefinition> = [
  ...
  { key: "highlights",  label: "Lichter",    group: "Licht", min: -1, max: 1, step: 0.01, default: 0,
    tooltip: "Korrigiert nur die hellen Bildbereiche. Negativ rettet überbelichtete Wolken/Haut." },
  ...
  { key: "blacks",      label: "Schwarz",    group: "Licht", min: -1, max: 1, step: 0.01, default: 0,
    tooltip: "Setzt den dunkelsten Punkt. Negativ verstärkt tiefes Schwarz." },
  { key: "highlightRecovery", label: "Lichter retten", group: "Licht", min: 0, max: 1, step: 0.01, default: 0,
    tooltip: "Rettet ausgebrannte Bereiche, indem geclippte Farbkanäle auf den Mittelwert der unclipped Kanäle gezogen werden. Entfernt Magenta-Cast in der Sonne. (RawTherapee-Blend-Modus inspiriert.)" },
  { key: "temperature", label: "Temperatur", group: "Farbe", min: -1, max: 1, step: 0.01, default: 0,
    tooltip: "Weißabgleich blau↔gelb. Positiv = wärmer." },
  { key: "tint",        label: "Tönung",     group: "Farbe", min: -1, max: 1, step: 0.01, default: 0,
    tooltip: "Weißabgleich grün↔magenta. Korrigiert Farbstich bei Mischlicht." },
  { key: "vibrance",    label: "Dynamik",    group: "Farbe", min: -1, max: 1, step: 0.01, default: 0,
    tooltip: "Sättigung, die schon-bunte Bereiche und Hauttöne schont. Sicherer als Sättigung." },
  { key: "saturation",  label: "Sättigung",  group: "Farbe", min: -1, max: 1, step: 0.01, default: 0,
    tooltip: "Globale Farbintensität. Schnell übertrieben — mit Dynamik kombinieren." },
  ...
  { key: "noiseReduction", label: "Rauschen",   group: "Detail", min: 0, max: 1, step: 0.01, default: 0,
    tooltip: "Bilateral-Filter glättet Rauschen, schont Kanten. Gut für ISO-hohe Aufnahmen." },
  { key: "localContrast",  label: "Klarheit",   group: "Detail", min: -1, max: 1, step: 0.01, default: 0,
    tooltip: "Mid-Frequenz-Kontrast. Positiv hebt Hauttextur und Wolkenstruktur, negativ glättet (Soft-Look). RawTherapee-Clarity-äquivalent." },
] as const;
