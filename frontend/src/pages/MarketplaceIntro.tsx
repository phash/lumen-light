...
// Bewusst KEIN horizontales Padding: der einbettende Kontext (Marketplace-
// Section bzw. Prerender-Wrapper) liefert px — sonst doppelte Einrueckung.
...
export default function MarketplaceIntro({ lang = "de" }: Props) {
  ...
  return (
    <div data-testid="marketplace-intro" className="pt-10 max-w-4xl mx-auto">
